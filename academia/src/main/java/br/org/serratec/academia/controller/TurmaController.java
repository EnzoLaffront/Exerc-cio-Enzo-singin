...
public class TurmaController {
	...
	//@GetMapping("/turma-resumido")
	//public ResponseEntity<List<TurmaResumidoDto>> findAllTurmaResumido() {
		//return new ResponseEntity<>(turmaService.findAllTurmaResumido(), HttpStatus.OK);
	...
	public ResponseEntity<Void> delete(@PathVariable Integer id) {
		boolean deletado = turmaService.delete2(id);
		if (deletado)
